...
const CONFIG = {
    ...
    immeubleId: <?php echo $projet->idImmeubleF; ?>,
    sommaireId: <?php echo $hasSommaire ? $sommaire->idSommaire : 'null'; ?>,
    URLROOT: '<?= URLROOT ?>',
    routes: {
        section: {
        ...
        sommaire: {
            ...
            updateHtmlTPG: '<?= linkTo("Sommaire", "updateHtmlTPG") ?>',
            getHtmlTPG: '<?= linkTo("Sommaire", "getHtmlTPG") ?>',
            getSommaire: '<?= linkTo("Sommaire", "clearHtmlTPG") ?>',
        },
        sectionDocument: {
            getAllDocumentsByIdImmeuble: '<?= linkTo("Section", "getAllDocumentsByIdImmeuble", ($projet ? $projet->idImmeubleF : null)) ?>',
        ...
        sectionLots: { //ajout
            ...
            removeLotToAcquire: '<?= linkTo("Section", "removeLotToAcquire") ?>',
        },
        variableSimulation: {
            ...
            getAllLibelles: '<?= linkTo("Section", "getAllLibellesVariables") ?>'
        }
    }
};
...
<div class="container-fluid" id="sommaire-container">
    <legend class="text-center legend font-weight-bold text-uppercase" style="margin-top: 2rem;">
        ...
        <button onclick="onClickPdf('pdf')" type="button" rel="tooltip" title="Ajouter"
        ...
        <div class="modal-content border-0 shadow">
            ...
            <form class="m-0" id="createSectionForm" onsubmit="return false;">
                <div class="modal-body p-4">
                    ...
                    <input type="hidden" name="idSommaireF" value="<?= $sommaire ? $sommaire->idSommaire : "" ?>">
...
<script src="<?= URLROOT ?>/public/assets/js/projet/documentHandler.js?v=1.4"></script>
<script src="<?= URLROOT ?>/public/assets/js/projet/actions.js?v=1.4"></script>
<script src="<?= URLROOT ?>/public/assets/js/projet/variableSimulation.js?v=1.4"></script>
<script src="<?= URLROOT ?>/public/assets/js/projet/sommaire.js?v=1.4"></script>
<script>
