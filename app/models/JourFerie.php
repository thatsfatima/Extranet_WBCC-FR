...
class JourFerie extends Model
{
    ...
    public function findJourFerie($anneeJourFerie, $idSiteF, $nomJourFerie) {
        $this->db->query("SELECT * FROM wbcc_jour_ferie WHERE anneeJourFerie = :anneeJourFerie AND nomJourFerie = :nomJourFerie AND idSiteF = :idSiteF");
