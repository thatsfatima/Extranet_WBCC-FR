...
if (isset($_GET['action'])) {
    ...
    if ($action == "saveInfosCompteRenduRT") {
        ...
        $db->query("UPDATE wbcc_releve_technique SET introduction=:introduction, contexte = :contexte, deroulementSeance = :deroulementSeance, editDate=:editDate, auteurDerniereModification=:auteurDerniereModification, precisionComplementaire =:precisionComplementaire,auteurCompteRenduRT=:auteurCompteRenduRT  WHERE idOpportunityF =:idOP");
        $db->bind("idOP", $idOP, null);
